...
export default function FbTable({
  ...
  const downloadQR = () => {
    ...
    ctx!.fillText('FB EQUIPMENT ASSET', newCanvas.width / 2, 35)
              ...
              >
                ...
                <td className="action-cell">
                  <button
                    ...
                    onClick={() =>
                      router.push(`/fbeq/detail?code=${item.asset_code}`)
                    }
                  >
                    <FiSearch />
                  </button>
          ...
          >
            ...
            >
              ...
              <h3 className="qr-title">
                QR F&B EQUIPMENT {qrItem.asset_code}
              </h3>

              <QRCodeCanvas
                id="qr-canvas"
                value={`${process.env.NEXT_PUBLIC_SITE_URL}/fbeq/detail?code=${qrItem.asset_code}`}
                size={250}
                level="H"
                includeMargin
              />
