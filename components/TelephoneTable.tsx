              ...
              >
                ...
                <td className="action-cell">
                  <button
                    ...
                    onClick={() =>
                      router.push(`/telephone/detail?code=${item.asset_code}`)
                    }
                  >
                    <FiSearch />
                  </button>
        ...
        {qrItem && (
          ...
          >
            ...
            >
              ...
              <h3>QR Telephone {qrItem.asset_code}</h3>

              <QRCodeCanvas
                value={`${process.env.NEXT_PUBLIC_SITE_URL}/telephone/detail?code=${qrItem.asset_code}`}
                size={200}
              />
            </motion.div>
          </motion.div>
