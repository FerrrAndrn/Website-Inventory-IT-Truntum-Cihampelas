...
export default function EngtoolTable({
  initialData,
  tableName = 'engineering_tool'
}: {
  initialData: any[]
  tableName?: string
}) {
  ...
  const downloadQR = () => {
    ...
    ctx!.fillText('ENGINEERING TOOLS ASSET', newCanvas.width / 2, 35)
              ...
              >
                ...
                <td className="action-cell">
                  <button
                    ...
                    onClick={() =>
                      router.push(`/engtool/detail?code=${item.asset_code}`)
                    }
                  >
                    <FiSearch />
                  </button>
          ...
          >
            ...
            >
              ...
              <h3 className="qr-title">
                QR Engineering Tool {qrItem.asset_code}
              </h3>

              <QRCodeCanvas
                id="qr-canvas"
                value={`${process.env.NEXT_PUBLIC_SITE_URL}/engtool/detail?code=${qrItem.asset_code}`}
                size={250}
                level="H"
                includeMargin
              />
