...
export default function CCTVTable({
  ...
  const downloadQR = () => {
    ...
    ctx!.fillText("CCTV ASSET", newCanvas.width / 2, 35)
              ...
              >
                ...
                <td className="action-cell">
                  <button
                    ...
                    onClick={() =>
                      router.push(`/cctv/detail?code=${item.asset_code}`)
                    }
                  >
                    <FiSearch />
                  </button>
          ...
          >
            ...
            >
              ...
              <h3 className="qr-title">
                QR CCTV {qrItem.asset_code}
              </h3>

              <QRCodeCanvas
                id="qr-canvas"
                value={`${process.env.NEXT_PUBLIC_SITE_URL}/cctv/detail?code=${qrItem.asset_code}`}
                size={250}
                level="H"
                includeMargin
              />
